...
nav(class="flex  w-full px-4 xl:px-[10%] py-4 bg-[#fafafa]  justify-between items-center h-[4.5rem] lg:h-[6rem]  shadow-md lg:shadow-none")
    div(class="hidden lg:flex w-3/4  gap-x-8 items-center font-semibold")
        ...
        NuxtLink(class="flex gap-x-2 items-center" to="/become-cleaner")
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    div(class="fixed h-[100svh] top-0 left-0 flex-col w-full bg-[rgb(255,255,255)] flex items-center gap-y-4" v-if="isMobileMenu")
        button(class="w-10 h-10 ml-auto mr-4 mt-4" @click="isMobileMenu = !isMobileMenu")
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3 6H21V8H3V6ZM3 11H21V13H3V11ZM3 16H21V18H3V16Z" fill="black"/>
            </svg>
