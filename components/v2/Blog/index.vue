<template lang="pug">
div(class="flex flex-col lg:items-center justify-center w-full lg:pl-[10%]  md:px-0 pl-4 lg:px-[1rem]")
  ...
  Swiper(
        ...
        :effect="'creative'"
        :space-between="2"
        :breakpoints="{ 1920: {slidesPerView: 4.5}, 1024: { slidesPerView: 3.5, spaceBetween: 2, }, 768: { slidesPerView: 2.5, spaceBetween: 2, }, 470: { slidesPerView: 1.5, spaceBetween: 2, }, 100: { slidesPerView: 1.2, spaceBetween: 1, }, }"
        :initialSlide="0"
