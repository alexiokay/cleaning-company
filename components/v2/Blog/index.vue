...
div(class="flex flex-col items-center justify-center w-full 3xl:pl-[10%]  2xl:pl-[10%] xl:pl-[5%] md:px-0 px-[1rem]")
  ...
  h2.flex.flex-col.text-center.text-4xl.font-bold.gap-y-3 Latest 
      span News & Articles
  ...
  Swiper(
        ...
        SwiperSlide(v-for="article in articles" :key="article.uuid" class="px-4 w-full md:w-3/4 py-[4rem] ")
