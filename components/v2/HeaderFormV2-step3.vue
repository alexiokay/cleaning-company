            ...
            div(class="w-full h-full flex flex-col gap-y-3 ")
                ...
                div(class="w-full flex gap-x-4 mt-6")
                    div(class="flex flex-col w-3/5 gap-y-2")
                        ...
                        input(class="w-full  border-[1px] border-[#181526]  rounded-[0.4375rem] px-[1.5rem] py-[0.5rem]" placeholder="Your Full Name")
                    div(class="flex flex-col w-2/5 gap-y-2")
                        p(class="text[#181526] font-bold") *optional
                        input(class="w-full  border-[1px] border-[#181526]  rounded-[0.4375rem] px-[1.5rem] py-[0.5rem]" placeholder="Company Name")
                div(class="w-full flex gap-x-4 items-center ")
                    div(class="flex flex-col w-2/5 gap-y-2")
                        p(class="text[#181526] font-bold") E-mail (for replies)
                        input(class="w-full  border-[1px] border-[#181526]  rounded-[0.4375rem] px-[1.5rem] py-[0.5rem]" placeholder="e.g. name@gmail.com")
                    div(class="flex flex-col w-3/5 gap-y-2")
                        p(class="text[#181526] font-bold") Phone
                        input(class="w-full  border-[1px] border-[#181526]  rounded-[0.4375rem] px-[1.5rem] py-[0.5rem]" placeholder="020-")
                ...
                div(class="flex gap-x-2 mt-6")
                    ...
                    button(@click="$emit('Book')" class="w-[16rem] h-[2.6rem] mt-2 text-white bg-[#563CF9] rounded-[0.4375rem]  items-center flex justify-center gap-x-3") 
