<template lang="pug">
div(class="w-full flex flex-col gap-y-4 px-2 lg:px-0 pt-[4.75rem] text-[#181526] ")
    ...
    div(class="flex flex-col md:flex-row flex-wrap gap-x-4 gap-y-4 mt-[2rem] justify-center w-full  2xl:w-[100rem] px-2 4xl:px-[6rem] mx-auto")
        div(class="flex flex-col image-1  gap-y-[1rem]  w-full shrink-0 md:w-[45%] px-2 xs:px-[2rem] lg:px-[4rem] 3xl:px-[10.56rem] py-8 lg:pt-[4.56rem] lg:pb-[7.75rem]  text-center  rounded-[1rem] aspect-[16/14] "  )
            ...
            button(class="bg-[#4e37e3] text-white px-[1.5rem] mt-auto rounded-xl py-[1rem] text-[0.9rem] lg:text-[1.1875rem] mx-auto w-auto font-bold flex items-center gap-x-2 justify-center") 
                ...
                p Fill in The Form
        div(class="flex flex-col image-2 gap-y-[1rem]  w-full shrink-0 md:w-[45%] px-2 xs:px-[2rem] lg:px-[4rem] 3xl:px-[10.56rem] py-8 lg:pt-[4.56rem] lg:pb-[7.75rem]  text-center  rounded-[1rem] aspect-[16/14] " )
        ...
        div(class="flex flex-col image-3 gap-y-[1rem]  w-full shrink-0 md:w-[45%] px-2 xs:px-[2rem] lg:px-[4rem] 3xl:px-[10.56rem] py-8 lg:pt-[4.56rem] lg:pb-[7.75rem]  text-center  rounded-[1rem] aspect-[16/14] " )
            ...
            p.flex.flex-col Sit back and wait for
                ...
                span AND THAT'S ALL!
        div(class="flex flex-col image-4 gap-y-[1rem]  w-full shrink-0 md:w-[45%] px-2 xs:px-[2rem] lg:px-[4rem] 3xl:px-[10.56rem] py-8 lg:pt-[4.56rem] lg:pb-[7.75rem]  text-center  rounded-[1rem] aspect-[16/14] " )
