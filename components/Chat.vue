...
div(class="flex flex-col space-y-4 pl-4 md md:pl-0")
    ...
    Transition(name="jump")
        div(v-show="isChatOpen" :class="!isChatOpen ? 'hidden' : ''" class="w-[100vw] fixed sm:relative -top-4 left-0 sm:w-[20rem] h-[100lvh] sm:h-[38.5rem] rounded-lg bg-[#F6f6f7]        shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)]")
            ...
            div(class="w-full relative h-[75vh] sm:h-[27rem] flex  flex-col items-center justify-between ")
