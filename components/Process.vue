...
div#cart-process(class="flex h-auto w-full items-center justify-center sm:justify-between md:justify-center md:gap-x-16")
    ...
    div(class="flex h-full justify-center sm:w-auto w-auto relative")
        div(v-for="(val, index, key) in steps" class="select-none w-[5.6rem] sm:w-[8rem] relative md:w-[9.5rem] h-[5rem]  flex flex-col justify-between items-center ")
            ...
            hr(v-if="index !== props.steps.length -1" class="absolute top-[1.2rem] left-[4.25rem] sm:left-[5.6rem] md:left-[6.5rem] w-[2.7rem] sm:w-[5rem] md:w-[6rem] h-[1.5px] bg-gray-800")
