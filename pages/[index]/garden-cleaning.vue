...
div(class="font-robotolight")
    ...
    div(v-show="steps.zipCode.active")
        ServiceCustomatizationWhyUs(:points="WhyUsPoints" :image="'https://images.pexels.com/photos/4750270/pexels-photo-4750270.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'")
            template(v-slot:subtitle) Need to clean your garden? It’s more affordable than you think.
        ...
        ServiceCustomatizationHeading2(:service="service" :image1="'https://images.pexels.com/photos/1453499/pexels-photo-1453499.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'" :image2="'https://images.pexels.com/photos/5027602/pexels-photo-5027602.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'")
        ...
        ServiceCustomatizationHeading3(:service="service" :image="'https://images.pexels.com/photos/10356030/pexels-photo-10356030.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'")
            template(v-slot:subtitle) Need to clean or maintance your garden? It’s more affordable than you think.
        ...
        ServiceCustomatizationTestimonials( )
        ServiceCustomatizationZipCodeForm(:service="service" @next="steps.zipCode.active = false, steps.property.active=true" :isBg="false" class="")
...
const steps = ref({
  ...
  property: {
    active: false,
    question: "Where do you need the cleaning service?",
    answers: [
      {
  ...
  often: {
    active: false,
    question: "How often do you need the cleaning service?",
    answers: [
      {
  ...
  areas: {
    active: false,
    question: "What areas do you want to be cleaned?",
    answers: [
      {
        title: "Kitchen",
        answered: false,
  ...
  size: {
    active: false,
    question: "Approximately how large is the area that needs cleaning?",
    answers: [],
  },
  specific: {
    active: false,
    question:
      "Are there any specific areas of concern or additional services you need?",
    answers: [],
  },
  date: {
    active: false,
...
const gallery = ref([
  ...
  "https://images.pexels.com/photos/5027619/pexels-photo-5027619.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
  "https://images.pexels.com/photos/6508413/pexels-photo-6508413.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
  "https://images.pexels.com/photos/7849457/pexels-photo-7849457.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
]);

const isFirstStep = computed(() => {
  return steps.value.zipCode.active;
});
